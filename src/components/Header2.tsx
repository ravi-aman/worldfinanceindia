                ...
                <div className="w-full m-0">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            <div className="flex items-center">
                                <Image src="/Rk-white.png" alt="Saas Logo" className="mx-10" height={40} width={40} /> {/* Imported logo from public folder */}
                            </div>
                            <Sheet>
                                <SheetTrigger asChild>
                                    <span>
                                        <FaBars className="h-5 w-5 md:hidden cursor-pointer" /> {/* Replaced SVG with FaBars */}
                                    </span>
                                </SheetTrigger>
                                <SheetContent>
                                    <SheetHeader>
                                        <SheetTitle className="flex justify-center">
                                            <Image src="/Rk-white.png" alt="Saas Logo" height={40} width={40} /> {/* Logo in sheet */}
                                        </SheetTitle>
                                    </SheetHeader>
